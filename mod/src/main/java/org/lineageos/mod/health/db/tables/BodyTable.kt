...
internal object BodyTable : Table {
    const val NAME = "body"
    ...
    private const val CREATE_CMD = "CREATE TABLE IF NOT EXISTS $NAME (" +
        ...
        "${RecordColumns.SEXUAL_ACTIVITY} INTEGER NOT NULL DEFAULT 0, " +
        "${RecordColumns.SYMPTOMS_OTHER} INTEGER NOT NULL DEFAULT 0, " +
        "${RecordColumns.SYMPTOMS_PHYSICAL} INTEGER NOT NULL DEFAULT 0, " +

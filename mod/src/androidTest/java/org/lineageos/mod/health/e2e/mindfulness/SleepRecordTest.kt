...
class SleepRecordTest : RecordTest<MindfulnessRecord, SleepRecord, MindfulnessRecordsRepo>() {
    ...
    override fun getById(id: Long): SleepRecord? {
        return repo.getSleepRecord(id)
    }

    override fun getAllInMetric(): List<SleepRecord> {
        return repo.allSleepRecords
    }

    override fun testRecordA(): SleepRecord {
        return SleepRecord(
            0L,
    ...
    override fun testRecordB(): SleepRecord {
        return SleepRecord(
            0L,
    ...
    override fun invalidRecord(): SleepRecord {
        return SleepRecord(
            0L,
            System.currentTimeMillis(),
            -8L,
    ...
    override fun updateTestRecord(record: SleepRecord) {
        record.apply {
